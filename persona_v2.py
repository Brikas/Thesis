...
import Thesis.standard_msg_reader as msg_reader
import re
import tiktoken
import shared_utils as utils
from enum import Enum

class ModuleIndexes(Enum):
    FBCHATS = "fb-chats"
...
class PersonaEncoder:
    ...
    def parse_whatsapp_messages(self, filenames, name_id, limit = None) -> None:
